...
- [`VirtualPresence/`](VirtualPresence/) — virtual presence detector app, driver, installation guide, and specification
- [`TuyaSNZB02/`](TuyaSNZB02/) — Tuya SNZB-02 temperature and humidity sensor driver and specification

## Start here

Open the README inside the area you want to work on:

- [`VirtualPresence/README.md`](VirtualPresence/README.md)
- [`TuyaSNZB02/README.md`](TuyaSNZB02/README.md)
...
- Script: [`scripts/Check-GroovySyntax.ps1`](scripts/Check-GroovySyntax.ps1)
- CI: [`.github/workflows/groovy-syntax-check.yml`](.github/workflows/groovy-syntax-check.yml)
